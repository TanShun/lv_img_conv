...
exports.applyPalette = exports.applyPaletteSync = exports.buildPalette = exports.buildPaletteSync = void 0;
/**
 * @preserve
...
function buildPaletteSync(images, _a) {
    ...
    images.forEach(function (image) { return paletteQuantizer.sample(image); });
...
function applyPaletteSync(image, palette, _a) {
...
function applyPalette(image, palette, _a) {
    ...
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_c) {
            return [2 /*return*/, new Promise(function (resolve, reject) {
                    ...
                    var timerId;
                    var iterator = imageQuantizer.quantize(image, palette);
                    var next = function () {
                        try {
                            var result = iterator.next();
                            if (result.done) {
...
function colorDistanceFormulaToColorDistance(colorDistanceFormula) {
    ...
    switch (colorDistanceFormula) {
        ...
        default:
            throw new Error("Unknown colorDistanceFormula ".concat(colorDistanceFormula));
    }
}
function imageQuantizationToImageQuantizer(distanceCalculator, imageQuantization) {
    ...
    switch (imageQuantization) {
        ...
        default:
            throw new Error("Unknown imageQuantization ".concat(imageQuantization));
    }
}
function paletteQuantizationToPaletteQuantizer(distanceCalculator, paletteQuantization, colors) {
    ...
    switch (paletteQuantization) {
        ...
        default:
            throw new Error("Unknown paletteQuantization ".concat(paletteQuantization));
    }
}
